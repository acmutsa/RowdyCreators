...
export const OfficerItem: FunctionComponent<OfficerItemProps> = ({
    ...
    return (
        <div className="h-[125px] w-full rounded-xl border-2 border-rc-darkblue p-[2px] text-rc-darkblue transition ease-in-out hover:bg-rc-darkblue hover:text-rc-yellow">
