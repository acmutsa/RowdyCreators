	...
	const teamMembers = [
		{
			...
			name: "Yash Verma",
			role: "President",
			bio: "I'm a senior majoring in Computer Science & Mathematics of Data and Computing. I'm interested in ML ops.",
			avatar: "YV",
			email: "yash.verma@rowdycreators.org",
			github: "https://github.com/yashverma",
			linkedin: "https://linkedin.com/in/-yv",
			interests: ["ML Ops", "Software", "Quantum Computing"],
			year: "Senior"
		},
		{
			id: 2,
			...
			avatar: "CL",
			email: "carlos.lopez@rowdycreators.org",
			github: "https://github.com/carloslopez",
			linkedin: "https://linkedin.com/in/carloslopezjr19",
			interests: ["AI/ML", "Software", "Research"],
			year: "Senior"
		},
		{
			id: 3,
			...
			avatar: "MB",
			email: "matthew.beck@rowdycreators.org",
			github: "https://github.com/matthewthomasbeck",
			linkedin: "https://https://www.linkedin.com/in/matthewthomasbeck",
			interests: ["Software", "Robotics", "Cloud"],
			year: "Senior"
		},
		{
			id: 4,
		...
		},
		{
			id: 5,
			name: "Jose Jiminez",
			role: "Retention & Engagement Officer",
			bio: "I am a senior majoring in Computer Science. I am interested in software development and cybersecurity.",
			avatar: "JS",
			email: "jose.jiminez@rowdycreators.org",
			github: "https://github.com/josejiminez",
			linkedin: "https://linkedin.com/in/josejiminez",
			interests: ["Cybersecurity", "Research", "Cyber Tools"],
			year: "Senior"
		},
		{
			id: 6,
			name: "Sarada Sivasaliam",
			role: "Media Officer",
			bio: "I am a senior majoring in Biomedical Engineering with a minor in Computer Science.",
			avatar: "SS",
			email: "sarada.sivasalai@rowdycreators.org",
			github: "https://github.com/saradasivasalai",
			linkedin: "https://linkedin.com/in/saradasivasalai",
		...
		},
		{
			...
			avatar: "DR",
			email: "diego.rodriguez@rowdycreators.org",
			github: "https://github.com/diegorodriguez",
			linkedin: "https://linkedin.com/in/diegorodriguez",
